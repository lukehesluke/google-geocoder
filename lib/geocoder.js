...
function GeoCoder(apiKey, bounds, region, componentFilters){
  ...
  if (bounds) {
      ...
      this.queryData.bounds = '' + bounds.southWest.lat + ',' + bounds.southWest.lng + '|' + bounds.northEast.lat + ',' + bounds.northEast.lng;
  }
  if (region) {
  ...
  if (componentFilters) {
      ...
      this.queryData.components = componentFilters.join('|');
  }
